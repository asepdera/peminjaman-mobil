<div class="flex flex-col h-full">
    ...
    <div class="flex flex-col h-[calc(100%-180px)] bg-[#121122]">
        <a href="/management" class="flex items-center w-full pl-[20px] h-[50px] text-white hover:bg-[#1f1f33]">
            <i class="fas fa-tachometer-alt"></i>
            <span class="ml-3">Dashboard</span>
        </a>
        <a href="/management/mobil" class="flex items-center w-full pl-[20px] h-[50px] text-white hover:bg-[#1f1f33]">
            <i class="fas fa-car mr-3"></i>
            <span>Mobil</span>
        </a>
        <a href="/management/peminjaman" class="flex items-center w-full pl-[20px] h-[50px] text-white hover:bg-[#1f1f33]">
